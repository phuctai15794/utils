...
if($_SESSION["dongdau-product"]["hienthi"]>0)
{
	if(! defined('WATERMARK_OVERLAY_IMAGE') ) define ('WATERMARK_OVERLAY_IMAGE', $_SESSION["dongdau-product"]["hinh"] );
}
else
{
	if(! defined('WATERMARK_OVERLAY_IMAGE') ) define ('WATERMARK_OVERLAY_IMAGE', "assets/images/watermark.png" );
}
...
if(! defined('MAX_FILE_SIZE') )				define ('MAX_FILE_SIZE', 1048576000000);						// 10 Megs is 10485760. This is the max internal or external file size that we'll process.  
if(! defined('CURL_TIMEOUT') )				define ('CURL_TIMEOUT', 20);							// Timeout duration for Curl. This only applies if you have Curl installed and aren't using PHP's default URL fetching mechanism.
if(! defined('WAIT_BETWEEN_FETCH_ERRORS') )	define ('WAIT_BETWEEN_FETCH_ERRORS', 3600);				// Time to wait between errors fetching remote file

//Browser caching
if(! defined('BROWSER_CACHE_MAX_AGE') ) 	define ('BROWSER_CACHE_MAX_AGE', 86400);				// Time to cache in the browser
if(! defined('BROWSER_CACHE_DISABLE') ) 	define ('BROWSER_CACHE_DISABLE', false);				// Use for testing if you want to disable all browser caching

//Image size and defaults
if(! defined('MAX_WIDTH') )					define ('MAX_WIDTH', 150000000);								// Maximum image width
if(! defined('MAX_HEIGHT') )				define ('MAX_HEIGHT', 150000000);							// Maximum image height
...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 50);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 50);							// Default thumbnail height. Allows overrid in timthumb-config.php
